  ...
  <body>
    ...
    <section class="hero-wrap d-flex js-fullheight">
    	<div class="forth js-fullheight d-flex align-items-center">
    		<div class="text">
    			<h2>Welcome to GetRooms</h2>
    			<h1 class="mb-5">Find A Perfect Place To Stay</h1>
		...
		<section class="ftco-section ftco-services">
          ...
          <div class="col-md-6 col-lg-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services">
              ...
              <div class="media-body">
                <h3 class="heading">GetRooms For Holidays</h3>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services">
              ...
              <div class="media-body">
                <h3 class="heading">GetRooms For Corporates</h3>
                <p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic.</p>
                <p><a href="#" class="btn-customize">Read More</a></p>
              </div>
            </div>    
          ...
          <div class="col-md-6 col-lg-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services">
              ...
              <div class="media-body">
                <h3 class="heading">For Weddings</h3>
                <p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic.</p>
                <p><a href="#" class="btn-customize">Read More</a></p>
              </div>
            </div>      
        ...
        <div class="carousel-rooms owl-carousel ftco-animate">
        	<div class="item">
        		<div class="room-wrap">
        			<a href="room.jsp" class="img" style="background-image: url(images/room-1.jpg);"></a>
        			<div class="text pt-4 pl-lg-5">
        				<h2><a href="room.jsp">Suite Room</a></h2>
        				<p class="rate">
        				...
        				<p class="d-flex price-details align-items-center pt-3">
        					...
        					<span class="price">$100<small>/ night</small></span>
        				</p>
        	...
        	<div class="item">
        		<div class="room-wrap">
        			<a href="room.jsp" class="img" style="background-image: url(images/room-2.jpg);"></a>
        			<div class="text pt-4 pl-lg-5">
        				<h2><a href="room.jsp">Family Room</a></h2>
        				<p class="rate">
        					<span class="icon-star"></span>
        					<span class="icon-star"></span>
        					<span class="icon-star"></span>
        				...
        				<p class="d-flex price-details align-items-center pt-3">
        					<span>Starting From</span>
        					<span class="price">$140<small>/ night</small></span>
        				</p>
        				<p><a href="#" class="btn-customize">Reserve A Room</a></p>
        			</div>
        		</div>
        	...
        	<div class="item">
        		<div class="room-wrap">
        			<a href="room.jsp" class="img" style="background-image: url(images/room-3.jpg);"></a>
        			<div class="text pt-4 pl-lg-5">
        				<h2><a href="room.jsp">Deluxe Room</a></h2>
        				<p class="rate">
        					<span class="icon-star"></span>
        					<span class="icon-star"></span>
        					<span class="icon-star"></span>
        				...
        				<p class="d-flex price-details align-items-center pt-3">
        					<span>Starting From</span>
        					<span class="price">$130<small>/ night</small></span>
        				</p>
        				<p><a href="#" class="btn-customize">Reserve A Room</a></p>
        			</div>
        		</div>
        	...
        	<div class="item">
        		<div class="room-wrap">
        			<a href="room.jsp" class="img" style="background-image: url(images/room-4.jpg);"></a>
        			<div class="text pt-4 pl-lg-5">
        				<h2><a href="room.jsp">Classic Room</a></h2>
        				<p class="rate">
        					<span class="icon-star"></span>
        					<span class="icon-star"></span>
        					<span class="icon-star"></span>
        				...
        				<p class="d-flex price-details align-items-center pt-3">
        					<span>Starting From</span>
        					<span class="price">$200<small>/ night</small></span>
        				</p>
        				<p><a href="#" class="btn-customize">Reserve A Room</a></p>
        			</div>
        		</div>
        	...
        	<div class="item">
        		<div class="room-wrap">
        			<a href="room.jsp" class="img" style="background-image: url(images/room-5.jpg);"></a>
        			<div class="text pt-4 pl-lg-5">
        				<h2><a href="room.jsp">Superior Room</a></h2>
        				<p class="rate">
        					<span class="icon-star"></span>
        					<span class="icon-star"></span>
        					<span class="icon-star"></span>
        	...
        	<div class="item">
        		<div class="room-wrap">
        			<a href="room.jsp" class="img" style="background-image: url(images/room-6.jpg);"></a>
        			<div class="text pt-4 pl-lg-5">
        				<h2><a href="room.jsp">Luxe Room</a></h2>
        				<p class="rate">
        					<span class="icon-star"></span>
        					<span class="icon-star"></span>
        					<span class="icon-star"></span>
        				...
        				<p class="d-flex price-details align-items-center pt-3">
        					<span>Starting From</span>
        					<span class="price">$500<small>/ night</small></span>
        				</p>
        				<p><a href="#" class="btn-customize">Reserve A Room</a></p>
        			</div>
        		</div>
