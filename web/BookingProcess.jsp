			...
			<div class="col-lg-6">
						...
						<div class="panel-body">
							...
							<form action="" data-toggle="validator" class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-lg-9">
										<input type="name"name="name" class="form-control" id="name" placeholder="Enter your name" value="<%=UserDetails.get("name")%>" disabled/>
									</div>
								</div><!--end form group-->
								<div class="form-group">
									<label for="phone" class="col-lg-3 control-label">Phone:</label>
									<div class="col-lg-9">
										<input type="text" name='phone' class="form-control" pattern="^[_0-9]{1,}$" maxlength="10" minlength="10" id="phone" placeholder="Enter your phone" value="<%=UserDetails.get("phone")%>" disabled/>
									</div>
								</div><!--end form group-->
								<div class="form-group">
									<label for="email" class="col-lg-3 control-label">Email:</label>
									<div class="col-lg-9">
										<input type="email" name="email" class="form-control" id="email" placeholder="Enter your email" value="<%=UserDetails.get("email")%>" disabled/>
									</div>
								</div><!--end form group-->
						...
						<div class="panel-body">
							...
							<form action="BookRoom.jsp" data-toggle="validator" class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-lg-9">
		    					<input type="text" class="form-control checkin_date" placeholder="Check-in date" value="<%=BookingDetails.get("checkindate")%>" disabled>
								...
								<div class="form-group">
									...
									<div class="col-lg-9">
		    					<input type="text" class="form-control checkin_date" placeholder="Check-in date" value="<%=BookingDetails.get("checkoutdate")%>" disabled/>
								...
								<div class="panel-body">
								<div class="form-group">
									<label for="dob" class="col-lg-10 control-label">No. Of guest : <%=BookingDetails.get("nog")%><br>No. of rooms: <%=BookingDetails.get("nor")%><br>No. of days: <%=BookingDetails.get("nod")%> Days </label>
									<div class="col-lg-2">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<form action="finalconfirmation" data-toggle="validator" class="form-horizontal">
								<div class="form-group">
									<label for="Bamount" class="col-lg-4 control-label">Total Amount:</label>
									<div class="col-lg-2">
                                                                            
                                                                           <i class='fa fa-inr'></i><%=BookingDetails.get("tc")%>"
									</div>
								</div><!--end form group-->
								...
								<div class="col-lg-5">
									...
									<div class="col-lg-5">
										...
										<input type="submit" style="font-size:12px;"class="btn btn-primary" value='Pay'/>
									</div>
								</div><!--end form group-->
