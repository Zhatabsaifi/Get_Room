	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	...
	        	<li class="nav-item active"><a href="services.jsp" class="nav-link">Amenities</a></li>
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-12 amenities d-md-flex">
    				<div class="img" style="background-image: url(images/amenities-1.jpg);"></div>
    				<div class="text p-5">
    			...
    			<div class="col-md-12 amenities d-md-flex">
    				<div class="img order-last" style="background-image: url(images/room-2.jpg);"></div>
    				<div class="text p-5">
    					<p class="price">Free</p>
    					<h2>Room Service</h2>
    					<p>A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth. When she reached the first hills of the Italic Mountains, she had a last view back on the skyline of her hometown Bookmarksgrove, the headline of Alphabet Village and the subline of her own road, the Line Lane.</p>
    			...
    			<div class="col-md-12 amenities d-md-flex">
    				<div class="img" style="background-image: url(images/amenities-2.jpg);"></div>
    				<div class="text p-5">
    					<p class="price">Free</p>
    					<h2>SPA &amp; Beauty Centre</h2>
    					<p>A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth. When she reached the first hills of the Italic Mountains, she had a last view back on the skyline of her hometown Bookmarksgrove, the headline of Alphabet Village and the subline of her own road, the Line Lane.</p>
    				</div>
    			</div>
    			<div class="col-md-12 amenities d-md-flex">
    				<div class="img order-last" style="background-image: url(images/amenities-3.jpg);"></div>
    				<div class="text p-5">
    					<p class="price">$300 <small>/ room</small></p>
